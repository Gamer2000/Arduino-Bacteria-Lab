...
// =====================================================
// Bacteria Lab v1.7 LINEAGE STATS
...
// - добавлена статистика поколений;
// - вторая строка статистики переключается между генами и родословной;
// - сохранены хемотаксис, мутации и сенсорные кнопки.
// =====================================================
...
void drawStatistics()
{
  ...
  if (millis() - statisticsPageTimer >= 3000)
  {
    ...
    statisticsPage = 1 - statisticsPage;
  }
...
void showBacteriaInfo(byte index)
{
  ...
  Tft.drawString(line, 25, 132, 2, WHITE);
