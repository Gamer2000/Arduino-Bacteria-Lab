...
// =====================================================
// Bacteria Lab v1.8.1 SPECIES INSPECTOR
...
// - экран SELECT имеет две страницы;
// - на второй странице снова показаны Curiosity и Persistence;
...
void showBacteriaInfo(byte index)
{
  ...
  else
  {
    ...
    Tft.drawString(line, 30, 155, 2, WHITE);

    snprintf(line, sizeof(line), "Speed:%u", b.speed);
    Tft.drawString(line, 30, 185, 2, WHITE);

    snprintf(line, sizeof(line), "Sensor:%u", b.sensor);
    Tft.drawString(line, 30, 215, 2, WHITE);

    snprintf(line, sizeof(line), "Turn:%u", b.turnGene);
    Tft.drawString(line, 30, 245, 2, WHITE);
