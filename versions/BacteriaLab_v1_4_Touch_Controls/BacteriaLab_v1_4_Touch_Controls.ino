...
// - сенсорные кнопки START, PAUSE и STOP внизу экрана.
// =====================================================
...
#define START_LEFT    4
#define START_RIGHT   76

#define PAUSE_LEFT    84
#define PAUSE_RIGHT   156

#define STOP_LEFT     164
...
void drawControlButtons()
{
  ...
  Tft.drawString("START", START_LEFT + 11, BUTTON_TOP + 10, 1, GREEN);
  Tft.drawString("PAUSE", PAUSE_LEFT + 11, BUTTON_TOP + 10, 1, YELLOW);
  Tft.drawString("STOP",  STOP_LEFT + 17, BUTTON_TOP + 10, 1, RED);
}
