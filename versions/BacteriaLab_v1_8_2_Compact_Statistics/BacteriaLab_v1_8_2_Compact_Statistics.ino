...
// =====================================================
// Bacteria Lab v1.8.2 COMPACT STATISTICS
...
// - на главном экране оставлена только краткая статистика A/B/D/F;
// - расширенные параметры доступны через SELECT;
// - экран SELECT имеет две страницы;
// - сохранены виды, хемотаксис, мутации, родословная и сенсорные кнопки.
// =====================================================
